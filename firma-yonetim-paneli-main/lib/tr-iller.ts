// Türkiye il ve ilçeleri (81 il). Çalışan ikamet bilgisinde il/ilçe seçimi ve
// ileride il/ilçe bazlı filtreleme için kullanılır. Anahtar = il adı.
...
// Türkçe alfabetik sırayla il adları (seçim kutusu için)
export const IL_ADLARI = Object.keys(TR_ILLER).sort((a, b) => a.localeCompare(b, "tr"));
